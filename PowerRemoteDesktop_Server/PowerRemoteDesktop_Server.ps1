...
$global:DesktopStreamScriptBlock = {
    ...
    try
    {
        ...
        {           
            try
            {                                                   
                $desktopImage = Get-DesktopImage -ScaleFactor $scaleFactor                                                                      
