...
Invoke-RemoteDesktopViewer -SecurePassword (ConvertTo-SecureString -String "Jade@123@Pwd" -AsPlainText -Force) -ServerAddress "127.0.0.1" -BlockSize "Size64" -ImageCompressionQuality 70 -PacketSize "Size16384"
